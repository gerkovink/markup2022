...
To conclude: 173 of 2270 individuals are hybrids of two species (`hybrid` = Sp). For their distinct 27 female and 26 male parent-species we can observe 28 pairwise combinations. However, the species of the male parent is often unknown. Most of the parents are hybrids themselves (EUL).
...
```{r plot, fig.width=9.8, fig.height=10.5, fig.cap="Network of hybrid lemurs' parental species", fig.alt=fig.alt, warning=FALSE}
...
################ SET SEED TO FIX LAYOUT OF THE GRAPH ###################
set.seed(999)                                                          #
